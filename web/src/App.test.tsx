...
// PROTOTYPE (proto/local-ux): the 'connecting a mailbox' tests moved to
// screens/Sources.test.tsx when the Sources screen became an integrations catalog. The
// shell's own Sources link and the callback landing below are still exercised here.
