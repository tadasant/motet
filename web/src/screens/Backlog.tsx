...
export function Backlog({
  ...
  // PROTOTYPE: which source item's three-stage detail is open under a news item, and
  // which news item is being pointed at (scrolled to and briefly highlighted) from one.
  ...
  return (
    <section aria-labelledby="backlog-heading">
      ...
      {/* Above the backlog rather than below it: the question "where did the thing I just
          ...
          nothing in flight. */}
      {/* PROTOTYPE: what has been pulled in but not yet paid for. */}
        ...
        <ul className="items">
          {items.map((item) => (
            ...
            >
              ...
              <p>{item.summary}</p>
              {/* PROTOTYPE: the source items behind this story, by title; each opens
                  its three-stage lifecycle. */}
              <p className="hint">
