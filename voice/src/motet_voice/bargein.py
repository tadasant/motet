...
class VadTurnDetector:
    ...
    #: The most recent frame's reading. Not an input to anything — it is what lets a live
    #: session say what the detector was hearing when nothing fired, which is the question
    #: a `barge_ins: 0` session could not answer (motet#93).
